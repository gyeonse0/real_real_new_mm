...
destroy_operators = [destroyer.random_removal] #여기에 오퍼레이터 추가
repair_operators = [Rep.greedy_truck_repair] #여기에 오퍼레이터 추가
...
destroy_probabilities = [1]  # 각각의 파괴 연산자에 대한 확률(성능기반의 score가 아니라, 확률만 고려함으로써 더욱 랜덤성 부여)
repair_probabilities = [1]  # 각각의 수리 연산자에 대한 확률
